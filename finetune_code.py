...
def train(
        ...
        data_path: str = "/home/arinjay/model-merging-adapters/dataset/LLMs/code/code_python_38k.json",
...
#  HF_ALLOW_CODE_EVAL=1 CUDA_VISIBLE_DEVICES=2 lm_eval --model hf --model_args pretrained=/home/models/Meta-Llama-3.2-3B-Instruct,peft=/home/vaibhav/MonteCLoRA/llama3.2-3b-instruct_code_finetuned_lora_qkv_2e-5_test/checkpoint-150 --tasks humaneval_instruct --log_samples --output_path ./llama_lora_humaneval  --batch_size 4   --trust_remote_code --confirm_run_unsafe_code --limit 64 



# |     Tasks     |Version|     Filter     |n-shot|  Metric   |   |Value |   |Stderr|
# |---------------|------:|----------------|-----:|-----------|---|-----:|---|-----:|
# |gsm8k_cot_llama|      3|flexible-extract|     8|exact_match|↑  |0.7672|±  |0.0116|
# |               |       |strict-match    |     8|exact_match|↑  |0.7582|±  |0.0118|